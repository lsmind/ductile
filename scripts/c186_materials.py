#!/usr/bin/env python3
# c186_materials.py — 27B 问询链v2 vs 裸27B：s2 三候选盲评
# 臂：gc2=27B管线(v0.18.2) / g27c2=27B问询链v2(裁决v2恢复可执行化推断) / gbar=裸27B
# 历史对照：g27c v1（裁决只收原话）60.7 输裸 7.3
import json, os
...
json.dump(mapping, open(f"{TB}/c186_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
