#!/usr/bin/env python3
# c188_materials.py — 9B加压提示词版 vs 裸27B：s2 三候选盲评
# 臂：gc2=27B直提管线 / g9d4=qwen3.5:9b加压版(结构硬指标guide) / gbar=裸27B
# 历史对照：g9c(未加压9b) 42.7；gbar 76.3-79.3；gc2 84-85
import json, os
...
json.dump(mapping, open(f"{TB}/c188_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
