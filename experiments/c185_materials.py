#!/usr/bin/env python3
# c185_materials.py — 27B 问询链 vs 裸27B：s2 三候选盲评
# 臂：gc2=27B管线(v0.18.2) / g27c=27B问询链(提问+裁决+黑名单) / gbar=裸27B
import json, os
...
json.dump(mapping, open(f"{TB}/c185_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
