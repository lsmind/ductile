#!/usr/bin/env python3
# c183_materials.py — 8B+管线 vs 裸27B 验收：s2 三候选盲评
# 臂：gc2=27B管线(v0.18.2) / g8b=8B管线(v0.18.2 注入+owner槽位) / gbar=裸27B
# 历史对照：g8(8B旧管线无注入无槽位) 41.3；gc2 81.3；gbar 66.7
import json, os
...
json.dump(mapping, open(f"{TB}/c183_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
