#!/usr/bin/env python3
# c190_materials.py — 27B加压版问询链 vs 裸27B：s2 三候选盲评
# 臂：gc2=27B直提旧guide / g27d=27B问询链+9B加压guide / gbar=裸27B
# 问题：加压guide在27B上是锦上添花还是画蛇添足？对照 g27c2(旧guide)=82.7
import json, os
...
json.dump(mapping, open(f"{TB}/c190_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
