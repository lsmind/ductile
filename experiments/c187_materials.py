#!/usr/bin/env python3
# c187_materials.py — 9B问询链 vs 裸27B：s2 三候选盲评
# 臂：gc2=27B直提管线 / g9c=qwen3.5:9b问询链 / gbar=裸27B
# 历史对照：lfm2.5-8b 问询链 36.3；27B 问询链 v2 82.7；裸 79.3
import json, os
...
json.dump(mapping, open(f"{TB}/c187_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
