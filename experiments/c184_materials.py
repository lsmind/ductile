#!/usr/bin/env python3
# c184_materials.py — 8B 问询链 vs 裸27B vs 27B管线：s2 三候选盲评
# 臂：gc2=27B管线(v0.18.2) / g8c=8B问询链(提问+裁决+黑名单) / gbar=裸27B
# 历史对照：g8b(8B管线无问询) 32.7；g8c 目标：追上或超过 gbar 79.3
import json, os
...
json.dump(mapping, open(f"{TB}/c184_map_r{_r}.json", "w"), ensure_ascii=False, indent=1)
